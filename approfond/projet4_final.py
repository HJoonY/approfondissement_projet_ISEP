## En tete - 작성 하기 ##
##Doxygen 생각해보기 ##
## sceinarion, fiche de test, documentation(sphinx 사용하기)
...
**** Bienvenue dans la simulation numérique de la Physique avec Pyton ****
...
#--------------------------------------
gap = (R2-R1)/10000
grap_x = numpy.arange(0,float(R2)*3,(gap))
